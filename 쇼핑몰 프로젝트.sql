...
CREATE TABLE MESSAGE_TB(
    ...
    MSG_TARGET      VARCHAR2(15)        NOT NULL,
    MSG_SENDER      VARCHAR2(15)        NOT NULL,
    MSG_CONTENT     VARCHAR2(4000)      NOT NULL,
    MSG_STATUS      CHAR(1)             DEFAULT 'N',
    MSG_OPDT        DATE                NULL,
    MSG_SDDT        DATE                DEFAULT SYSDATE,
    FOREIGN KEY (MSG_TARGET) REFERENCES MEMBERS_TB (MB_ID),
    FOREIGN KEY (MSG_SENDER) REFERENCES MEMBERS_TB (MB_ID)
);
